...
exports.PolynomialEasing = void 0;
const easing_1 = require("./easing");
const math_1 = require("../../util/math");
const function_1 = require("../../util/function");
class PolynomialEasing extends easing_1.Easing {
    constructor(config) {
    ...
    calculate(x) {
        return (0, function_1.transform)(a => Math.pow(a, this._degree), this._direction, x);
    }
}
exports.PolynomialEasing = PolynomialEasing;
